...
## Зад. 2
Да се напише програма, която пресмята и отпечатва на екрана размера на текстовия файл “file.txt” в байтове, използвайки някои от функциите seekp(...), seekg(...), tellp(), tellg(), а не чрез последователно прочитане байт по байт от файла и броене колко байте сме прочели.
